...
DS_API.prototype.Error_JWT_get_token = 'Error_JWT_get_token';
DS_API.prototype.Error_consent_required = 'consent_required';
...
// First check/get/create access token.
// If we can't create a token then need to save the current call
